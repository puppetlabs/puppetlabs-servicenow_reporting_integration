...
* [`servicenow_reporting_integration::event_management`](#servicenow_reporting_integrationevent_management)
...
* `servicenow_reporting_integration`: This class contains the common setup code for servicenow_reporting_integration::incident_management
and servicenow_reporting_integration::event_management.

### Functions

* [`servicenow_reporting_integration::check_report_processor`](#servicenow_reporting_integrationcheck_report_processor)
...
The servicenow_reporting_integration::event_management class.
...
The servicenow_reporting_integration::check_report_processor function.
